...
self isLeaf iid | isLeaf iid = H.HsVar . H.UnQual $ H.HsIdent "self"
                | otherwise = H.HsParen $ H.HsApp
                                    (H.HsVar . H.UnQual . H.HsIdent $ "to" ++ typeFor iid)
                                    (H.HsVar . H.UnQual $ H.HsIdent "self")

applySelf isLeaf iid call = H.HsInfixApp (self isLeaf iid) (H.HsQVarOp $ mkSymbol "^.") call
...
applyParam param@(I.Param optional (I.Id p) ptype [I.Mode In] ext) =
    ...
    case ptype of
        ...
        I.TyFrozenArray _ -> H.HsApp (mkVar "toJSVal") (H.HsParen (H.HsApp (mkVar "array") pname))
        I.TyOptional (I.TySequence _ _) -> H.HsApp (mkVar "toJSVal") (H.HsParen (H.HsApp (mkVar "array") (
            H.HsParen (H.HsApp (mkVar "mapM") (H.HsApp (mkVar "toJSVal") pname)))))
        I.TyOptional (I.TySafeArray _) -> H.HsApp (mkVar "toJSVal") (H.HsParen (H.HsApp (mkVar "fmap") (H.HsApp (mkVar "array") pname)))
        I.TyOptional (I.TyFrozenArray _) -> H.HsApp (mkVar "toJSVal") (H.HsParen (H.HsApp (mkVar "fmap") (H.HsApp (mkVar "array") pname)))
        I.TyName "GLintptr" Nothing -> defaultUndefined optional $ H.HsApp (mkVar "integralToDoubleToJSVal") pname
        I.TyName "GLsizeiptr" Nothing -> defaultUndefined optional $ H.HsApp (mkVar "integralToDoubleToJSVal") pname
        I.TyName "GLint64" Nothing -> defaultUndefined optional $ H.HsApp (mkVar "integralToDoubleToJSVal") pname
        I.TyName "GLuint64" Nothing -> defaultUndefined optional $ H.HsApp (mkVar "integralToDoubleToJSVal") pname
        I.TyInteger LongLong -> defaultUndefined optional $ H.HsApp (mkVar "integralToDoubleToJSVal") pname
        I.TyApply _ (I.TyInteger LongLong) -> defaultUndefined optional $ H.HsApp (mkVar "integralToDoubleToJSVal") pname
        _ -> H.HsApp (mkVar "toJSVal") pname

defaultUndefined :: I.Optionality -> H.HsExp -> H.HsExp
...
returnType enums (I.TySafeArray t) _ wrapType e =
    ...
    case tyRet enums False t [] wrapType of
        ...
        _ -> error "Issue with wrapType?"
returnType enums (I.TyFrozenArray t) _ wrapType e =
    H.HsInfixApp
      (H.HsParen e)
      (H.HsQVarOp (mkSymbol ">>=")) $
    case tyRet enums False t [] wrapType of
...
returnType enums (I.TyOptional (I.TySafeArray t)) _ wrapType e =
        H.HsInfixApp
          ...
          case tyRet enums False t [] wrapType of
            ...
            _ -> error "Issue with wrapType?"
returnType enums (I.TyOptional (I.TyFrozenArray t)) _ wrapType e =
        H.HsInfixApp
          (H.HsParen e)
          (H.HsQVarOp (mkSymbol ">>=")) $
          case tyRet enums False t [] wrapType of
...
returnType _ I.TyVoid _ _ e =
        H.HsApp
          (mkVar "void")
          (H.HsParen e)
returnType enums (I.TyPromise t) ext wrapType e = returnType enums t ext wrapType $
        H.HsInfixApp
          (H.HsParen e)
          (H.HsQVarOp (mkSymbol ">>="))
          (mkVar "readPromise")
